...
namespace Taarafo.Core.Tests.Acceptance.Apis.Comments
{
    ...
    {
        [Fact]
        private async Task ShouldPostCommentAsync()
        {
            // given
        ...
        [Fact]
        private async Task ShouldGetAllCommentsAsync()
        {
            // given
        ...
        [Fact]
        private async Task ShouldGetCommentByIdAsync()
        {
            // given
        ...
        [Fact]
        private async Task ShouldPutCommentAsync()
        {
            // given
            Comment randomComment = await PostRandomCommentAsync();
        ...
        [Fact]
        private async Task ShouldDeleteCommentAsync()
        {
            // given
            Comment randomComment = await PostRandomCommentAsync();
            Comment inputComment = randomComment;
