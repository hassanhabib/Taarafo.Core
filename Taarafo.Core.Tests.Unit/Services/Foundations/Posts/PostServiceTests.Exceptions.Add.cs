...
namespace Taarafo.Core.Tests.Unit.Services.Foundations.Posts
{
    public partial class PostServiceTests
    {
        ...
        [Fact]
        private async Task ShouldThrowDependencyValidationExceptionOnAddIfPostAlreadyExsitsAndLogItAsync()
        {
            // given
            ...
            var alreadyExistsPostException =
                new AlreadyExistsPostException(
                    message: "Post with the same id already exists.",
            ...
            var expectedPostDependencyValidationException =
                new PostDependencyValidationException(
                    message: "Post dependency validation occurred, please try again.", 
                       innerException: alreadyExistsPostException);
